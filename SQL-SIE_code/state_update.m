function [nextState,collide,inROI] = state_update(currentState, agent_id, next_action, NumberStateRows, NumberStateCols, obstacle_num, obstacle_position, ROI_area)
...
if nextState(1) >= ROI_area && nextState(2) >= ROI_area 
    inROI = 1;
else
    inROI = 0;
end
